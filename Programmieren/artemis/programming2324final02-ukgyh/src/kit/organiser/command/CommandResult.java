...
/**
 * This class represents the result of a kit.organiser.command. It contains a message and a type. The type indicates whether the
 * kit.organiser.command was successful or not. The message contains additional information about the result.
 *
